...
import {AddQuizContent} from '../ApiFunctions/AddQuizApi';
import 'react-toastify/dist/ReactToastify.css';
import {toast, ToastContainer} from 'react-toastify';
const AddContentQuizBtn = ({ part, course, section, Topic, refreshData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(QuizName===''){
     ...
     let result = AddQuizContent(questions,course.label, section.value, Topic.value,QuizName);
     if (result) {
      setQuestions([]);
      setQuizName("");
...
export default AddContentQuizBtn;
