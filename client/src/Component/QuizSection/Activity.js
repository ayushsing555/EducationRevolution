      ...
      <Grid container spacing={2}>
        <Grid item xs={4}>
          <Box display="flex" alignItems="center" justifyContent="center">
            ...
            <Typography variant="subtitle1">20 Coins</Typography>
          </Box>
        </Grid>
        <Grid item xs={4}>
          <Box display="flex" alignItems="center" justifyContent="center">
            <ScheduleIcon fontSize="large" color="primary" style={{marginRight: '5px'}} />
            <Typography variant="subtitle1">1 Daily Streak</Typography>
          </Box>
        </Grid>
        <Grid item xs={4}>
          <Box display="flex" alignItems="center" justifyContent="center">
            <TrendingUpIcon fontSize="large" color="primary" style={{marginRight: '5px'}} />
            <Typography variant="subtitle1">12 Max Streak</Typography>
          </Box>
        </Grid>
      </Grid>
    </Paper>
